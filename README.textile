...
must be executed manually. You can use the elasticsearch API for querying, e.g.:

    @curl "http://weywot2.hbz-nrw.de:9200/resources/resource/HT002619538"@

The result shows the data which also LobidResources2ElasticsearchLobidTest produces.
